 ...
 */
  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="<?php echo web_root; ?>"> <img src="logo.png" width="50px"> PESO San Carlos</a>
...
<!-- START FOOTER -->
  <footer class="ftco-footer ftco-section" style="background-color: ">
    <div class="container">
      <div class="row mb-100">
        <div class="col-md">
         <div class="ftco-footer-widget mb-4">
          <h2 class="ftco-heading-2">About</h2>
          <p>Provincial Employment Services Office (PESO) is a non-fee charging multi-dimentional employment service facility established in all LGUs in coordination with the DOLE persuant to RA No.8759 also known as "PESO Act of 1999".</p>
        </div>
      </div>
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4 ml-md-4">
          ...
          <ul class="list-unstyled">
            <li><a class="py-2 d-block">Jobseekers</a></li>
            <li><a class="py-2 d-block">Students</a></li>
            <li><a class="py-2 d-block">OFWs</a></li>
            <li><a class="py-2 d-block">Labor Market Info Users</a></li>
            <li><a class="py-2 d-block">Displaced Workers</a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              <li><span class="icon icon-map-marker"></span><span class="text">Speaker Eugenio Perez Bldg., San Carlos City, Pangasinan.</span></li>
              <li><a href="#"><span class="icon icon-phone"></span><span class="text">(075) 522 6715</span></a></li>
              <li><a><span class="icon icon-envelope"></span><span class="text">peso.sccp@gmail.com</span></a></li>
              <li><a href="www.facebook.com/sccp.peso"><span class="icon icon-facebook"></span><span class="text">sccp.peso</span></a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p>
          Copyright PESO San Carlos <script>document.write(new Date().getFullYear());</script> | All rights reserved
        </p>
      </div>
    </div>
  </div>
