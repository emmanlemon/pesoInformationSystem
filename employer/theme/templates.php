...
<div class="wrapper">
  ...
  <header class="main-header">
   <!-- Logo -->
    <a href="../" class="logo" style="background-color: #136f1a">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini" ><b></b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="../logo.png" width="40px" alt="User Image"><b> PESO</b></span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" role="navigation" style="background-color: #136f1a">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <?php
              $user = New User();
              $singleuser = $user->single_user($_SESSION['EMPLOYER_USERID']);

          ?>

          <!-- User Account: style can be found in dropdown.less -->
          <li class="dropdown user user-menu" style="padding-right: 15px;"  >
            <a href="../logout.php" class="dropdown-toggle" data-toggle="dropdown-menu">
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo web_root; ?>employer/user/controller.php?action=photos" enctype="multipart/form-data" method=
                                "post">
  ...
  <aside class="main-sidebar">
    ...
    <div style="margin-left:40px">
      <a class="navbar-brand" > <img src="../peso.png" width="97px"><span>  PESO San Carlos</span></a>
      </div>
 
      <!-- sidebar menu: : style can be found in sidebar.less -->
      <ul class="sidebar-menu"  style="margin-top:150px"> 
        <li  class="<?php echo (currentpage() == 'index.php') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>employer/index/">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>  
          </a> 
        </li> 
        <li class="<?php echo (currentpage() == 'vacancy') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>employer/vacancy/">
            <i class="fa fa-suitcase"></i> <span>Vacancy</span> 
          </a>
        </li>
        <li class="<?php echo (currentpage() == 'employee') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>employer/employee/">
            <i class="fa fa-users"></i> <span>Employee</span> 
          </a>
        </li> 
        <li class="<?php echo (currentpage() == 'applicants') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>employer/applicants/">
            <i class="fa fa-users"></i> <span>Applicants</span> 
            <span class="label label-primary pull-right">
              <?php
                $sql = "SELECT count(*) as 'APPL' FROM `tbljobregistration`";
                $mydb->setQuery($sql);
      ...
      <ol class="breadcrumb">
        <?php
          ...
          if ($title!='Home') {
            ...
            echo '<li><a href='.web_root.'employer/><i class="fa fa-dashboard"></i> Home</a></li>';
            echo  $active_title;
  ...
  <footer class="main-footer" style="text-align:center;">
    <strong>Copyright PESO San Carlos 2022</strong> | All rights
    reserved.
  </footer>
   ...
   <!--      <script src="<?php echo web_root; ?>employer/js/jquery.dataTables.min.js"></script>
<script src="<?php echo web_root; ?>employer/js/dataTables.bootstrap.min.js"></script>
 <script type="text/javascript" src="<?php echo web_root; ?>js/jquery-1.10.2.js"></script>       
        ...
        <script src="<?php echo web_root; ?>employer/js/ekko-lightbox.js"></script>
        <script src="<?php echo web_root; ?>employer/js/lightboxfunction.js"></script> 
  -->
<!-- jQuery 2.1.4 --> 
