...
<body class="hero-wrap js-fullheight " style="background-color:#136f1a; " >
<div class="container">
...
<div class="login-box" style="margin-top:50px;">
  ...
  <div class="login-box-body"style="border: 1px solid; padding: 20px;box-shadow: 10px 15px black; " >
    <div class="login-box-msg"><img src="logo.png" width="180px"height="120"><p> <h1>PESO Sign-in</h1></p></div>
    <hr/>
    ...
    if ($res==true) { 
      ...
      // if ($_SESSION['ROLE']=='Administrator' || $_SESSION['ROLE']=='Cashier'){
        ...
        unset($_SESSION['PICLOCATION']);
         ...
         redirect(web_root."admin/index/index.php");
      // } 
    }else{
