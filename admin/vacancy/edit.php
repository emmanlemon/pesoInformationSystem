                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                          <select class="form-control input-sm" id="SECTOR_VACANCY" name="SECTOR_VACANCY">
                          <option value="None">Select</option>
                           <option <?php echo ($res->SECTOR_VACANCY=='Finance') ? "SELECTED" :"" ?>>Finance</option>
                           <option <?php echo ($res->SECTOR_VACANCY=='Technology') ? "SELECTED" :"" ?>>Technology</option>
                           <option <?php echo ($res->SECTOR_VACANCY=='Manufacturing') ? "SELECTED" :"" ?>>Manufacturing</option>
                           <option <?php echo ($res->SECTOR_VACANCY=='Production') ? "SELECTED" :"" ?>>Production</option>
                           <option <?php echo ($res->SECTOR_VACANCY=='Economics') ? "SELECTED" :"" ?>>Economics</option>
                           <option <?php echo ($res->SECTOR_VACANCY=='Agriculture') ? "SELECTED" :"" ?>>Agriculture</option>
                           <option <?php echo ($res->SECTOR_VACANCY=='Public Sector') ? "SELECTED" :"" ?>>Public Sector</option>
                        </select>
                      </div>
                    </div>
                  </div>  
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8"> <a href="index.php" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Back</strong></a> 
