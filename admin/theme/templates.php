 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <aside class="main-sidebar" >
    ...
    <div style="margin-left:40px">
      <a class="navbar-brand" > <img src="../logo.png" width="97px"><span>  PESO San Carlos</span></a>
      </div>
      ...
      <ul class="sidebar-menu" style="margin-top:150px" > 
        ...
        <li  class="<?php echo (currentpage() == 'index.php') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/index">
        ...
        <li class="<?php echo (currentpage() == 'category') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>admin/category/">
            <i class="fa fa-list"></i> <span>Category of Location</span>  
          </a>
        </li> 
       <!--  <li class="treeview">
          <a href="#">
