            ...
            <!-- <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut <br> et dolore magna aliqua. Ut enim ad minim veniam</p> -->
             ...
             <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                      <a href="index.php" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Back</strong></a> 
                       <button class="btn btn-primary btn-sm" name="save" type="submit" ><span class="glyphicon glyphicon-arrow-left"></span>  Save</button> 
